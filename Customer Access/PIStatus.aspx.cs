...
using VOMS_ERP.Enquiries;

namespace VOMS_ERP.Customer_Access
{
    public partial class PIStatus : System.Web.UI.Page
    {
        # region variables
        int res;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Ajax.Utility.RegisterTypeForAjax(typeof(PIStatus));
        ...
        protected void btnExcelExpt_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string CusID = "";//FromRcvdDt = "", ToRcvdDt = "",
                ...
                DataSet ds = FEBL.Select_PESearch(FrmDt, ToDat, FENo, "", "", Subject, Status, dept, Cust, CnctPrsn, CreatedDT, LoginID, CusID, new Guid(Session["CompanyID"].ToString()));
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    if (FrmDt != "" && Convert.ToDateTime(ToDat).ToString("dd-MM-yyyy") == "01-01-0001" || CommonBLL.DateDisplay_2(Convert.ToDateTime(ToDat)) == CommonBLL.EndDtMMddyyyy_FS)
                        ToDat = "";
                    string MTitle = "STATUS OF PURCHASE ENQUIRIES RECEIVED", MTcustomer = "", MTDTS = "";
                    if (HFCust.Value != "")
