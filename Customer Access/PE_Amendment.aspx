<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true" CodeBehind="PE_Amendment.aspx.cs" Inherits="VOMS_ERP.Customer_Access.PE_Amendment" %>
...
<table class="MainTable" align="center" id="headerTable">
            ...
            <td class="bcTdNewTable">
                <table width="100%">
                    <tr class="bcTRTitleRow">
                        <td>
                            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Foreign Enquiry Amendment Status"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#tblOscarNominees').dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "PI_Webservice.asmx/GetPEAmdItems",
    ...
    <script type="text/jscript">
        ...
        $('.Exp').live('click', function (e) {
            ...
            $('[id$=ExportHF]').val(Id);
            var res = FeAmendments.ReportExp(Id);
