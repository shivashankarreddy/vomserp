<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true"
    CodeBehind="Customer_LocalQuotation.aspx.cs" Inherits="VOMS_ERP.Customer_Access.Customer_LocalQuotation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="txtlquotno" CssClass="bcAsptextbox" MaxLength="350"
                                            onkeypress='return SpclChars(event);' onchange="CheckEnquiryNo();"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hfFeIssueDt" runat="server" Value="" />
                                ...
                                <tr>
                                    <td style="overflow: auto;" colspan="6">
                                        <table style="width: 100%; overflow: auto;">
                                            <tr>
                                                <td>
                                                    <div id="divLQItems" runat="server" style="overflow: auto; width: 100%; max-height: 290px;">
                                                    </div>
                                                </td>
                                            </tr>
                                                                ...
                                                                <table style="width: 100%; overflow: auto;">
                                                                    <tr>
                                                                        ...
                                                                        <td class="bcTdnormal">
                                                                            ...
                                                                            <font style="font-family: Verdana; font-size: 12px;">Days</font>
                                                                        </td>
                                                                        <td colspan="4">
                                                                            &nbsp;
                                                                        </td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            if ($('[id$=hfFeIssueDt]').val() != '') {
                var strdateEnqDT = $('[id$=hfFeIssueDt]').val();
        ...
        function CalculateExDuty() {
            ...
            var res = Customer_LocalQuotation.CalculateExDuty(ExDutyAmt, DiscountAmt, PackingAmt, SalesTaxAmt, AdsnlCgrs, Discount, ExDuty, SalesTax,
        ...
        function NextPage() {
            ...
            if (ddlRowsChanged == 'NAN' || ddlRowsChanged <= 0) {
                ...
                var result = Customer_LocalQuotation.NextPage(hfCurrentPage, ddlRowsChanged);
        ...
        function PrevPage() {
            ...
            if (ddlRowsChanged == 'NAN' || ddlRowsChanged <= 0) {
                ...
                var result = Customer_LocalQuotation.PrevPage(hfCurrentPage, ddlRowsChanged);
                var getDivFEItems = GetClientID("divLQItems").attr("id");
                $('#' + getDivFEItems).html(result.value);
                Expnder();
            }
        ...
        function RowsChanged() {
            ...
            var result = Customer_LocalQuotation.RowsChanged(hfCurrentPage, ddlRowsChanged);
            var getDivFEItems = GetClientID("divLQItems").attr("id");
            $('#' + getDivFEItems).html(result.value);
            Expnder();
        }
    ...
    <script type="text/javascript">
        function FillItemGrid(obj1, obj2) {
            ...
            var result = Customer_LocalQuotation.FillItemGrid(obj2, obj1, obj3, 0, 0, obj5, spec, make, qty, PNo, Price, Amount);
            var getDivLQItems = GetClientID("divLQItems").attr("id");
        ...
        function DeleteItem(obj1) {
            var result = Customer_LocalQuotation.DeleteItem(obj1);
            var getDivLQItems = GetClientID("divLQItems").attr("id");
            $('#' + getDivLQItems).html(result.value);
            Expnder();
        }
        function FillItemDRP(id) {
            ...
            var sv = $('#' + ddlCat).val();
            var result = Customer_LocalQuotation.FillItemDRP(id, sv);
            var getDivLQItems = GetClientID("divLQItems").attr("id");
            $('#' + getDivLQItems).html(result.value);
            Expnder();
        }
        ...
        function AddItemColumn(id) {
            ...
            if ((sv == undefined || sv == '0') || (Qty == '' || Qty == '0' || Qty == '0.00') || (Price == '' || Price == '0' || print == '0.00') || (Units == '' || Units == '0' || Units == undefined)) {
                ...
                if (flag == 1) {
                    ...
                    if (Units == undefined)
                        Units = '';
                    var result = Customer_LocalQuotation.AddNewRow(id, sv, PrtNo, spec, Make, Qty, Units, Price, Amnt, Rmrks);
                    var getDivLQItems = GetClientID("divLQItems").attr("id");
                    $('#' + getDivLQItems).html(result.value);
                }
            }
            ...
            if (obj3 != '0' && descrip != '') {
                if (Discount == '100' || Discount == '100.00') {
                    if (confirm("Are you sure you want to Give " + Discount + "% Discount ?")) {
                        var result = Customer_LocalQuotation.SaveChanges(obj - 1, obj, obj3, 0, 0, spec, make, qty, Price, Amount, Rmrks, Discount, UnitID, ExDuty, CHKExDuty, CHKDiscount, CHKSalesTax, CHKPacking, CHKAdChrgs, Chaild);
                        var getDivLQItems = GetClientID("divLQItems").attr("id");
                        $('#' + getDivLQItems).html(result.value);
                    }
                    else {
        ...
        function doConfirm(id) {
            if (confirm("Are you sure you want to Continue?")) {
                var result = Customer_LocalQuotation.DeleteItem(id);
                var getDivLQItems = GetClientID("divLQItems").attr("id");
                $('#' + getDivLQItems).html(result.value);
                Expnder();
            }
        ...
        function doConfirmPayment(id) {
            if (confirm("Are you sure you want to Delete Payment?")) {
                var result = Customer_LocalQuotation.PaymentDeleteItem(id);
        ...
        function getPaymentValues(RNo) {
            ...
            if (PercAmt != '0' && PercAmt != '' && Desc != '') {
                var result = Customer_LocalQuotation.PaymentAddItem(RNo, PercAmt, Desc);
                var getdivPaymentTerms = GetClientID("divPaymentTerms").attr("id");
                $('#' + getdivPaymentTerms).html(result.value);
                if ($('[id$=HfMessage]').val() != '') {
        ...
        function uploadComplete() {
            var result = Customer_LocalQuotation.AddItemListBox();
        ...
        $('#lnkdelete').click(function () {
            if ($('#lbItems').val() != null) {
                ...
                if (IsDelete) {
                    var result = Customer_LocalQuotation.DeleteItemListBox($('#lbItems').val());
        ...
        function Myvalidations() {
            try {
                ...
                if ($('[id$=tblItems]')[0].rows.length > '0') {
                    ...
                    if (rowCount > 0) {
                        var result = Customer_LocalQuotation.ValidateRowsBeforeSave();
                ...
                var result = Customer_LocalQuotation.Validate_SubItem_BeforeSaving();
                if (result.value != "") {
        ...
        function fnOpen(id, rowIndex) {
            ...
            window.showModalDialog("../Masters/TermsNConditions.aspx?TAr=LQ/LPO", "509", sFeatures);
        }
    ...
    <script type="text/javascript">
        function CheckEnquiryNo() {
            ...
            var result = Customer_LocalQuotation.CheckEnquiryNo(enqNo);
    ...
    <script type="text/jscript">
        $('[src*=expand]').live('click', function (e) {
            ...
            if ($('[id$=ckhChaild' + TRid + ']').is(':checked')) {
                var NewTbl = Customer_LocalQuotation.Expand_LPOs(ItemID, TRid);
        ...
        function GetItemDesc_Spec(ItmID, id) {
            var rslt = Customer_LocalQuotation.GetItemDesc_Spec(ItmID, id);
        ...
        function Add_Sub_Itms1(TrID, RowID, ClickRID, RowIndex, IsAdd) {
            ...
            if (IsAdd == true) {
                if (ItemID.trim() == "" || ItemID.trim() == 0) {
                    ...
                    var res;
                    res = Customer_LocalQuotation.Add_Sub_Itms(RowID, TrID, SubRowID, ParentItemID, ItemID, ItmDesc, Spec, PNo, Make, Qty, Rate, Disc, exduty, UnitID, Remarks,
        ...
        function Delete_SubItem(TrID, SNo, x) {
            if (confirm("Are you sure you want to Delete?")) {
                ...
                var ParentItemID = $('#HItmID' + TrID).val();
                var ItemID = $('#hfSubItemID' + ClickRID).val();
                var res = Customer_LocalQuotation.Delete_SubItem(ParentItemID, TrID, SNo, ItemID);
                $(".DEL" + TrID).remove();
        ...
        function CalculateTotalAmount(obj) {
            ...
            try {
                ...
                if ((Discount == 0) && (txtExdt == 0) && (txtDsnt == 0) && (txtPkng == 0) && (txtAdchrgs == 0) && (ExDuty == 0) && (Price != 0) && (qty != 0) && (obj3 == 0)) {
                    var result = Customer_LocalQuotation.SaveChangesWhileRateChange(obj - 1, obj, obj3, 0, 0, spec, make, qty, Price, Amount, Rmrks, Discount, UnitID, ExDuty, CHKExDuty, CHKDiscount, CHKSalesTax, CHKPacking, CHKAdChrgs, Chaild);
                    if (result.value) {
