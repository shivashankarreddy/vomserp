<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true"
    CodeBehind="FQComparision_Customer.aspx.cs" Inherits="VOMS_ERP.Customer_Access.FQComparision_Customer" %>
...
//            }
        ...
        function CheckIndividual(id, RNo, QNo) {
            ...
            if ($("#ch1" + id + "")[0].checked) {
                if (rowCount > 2) {
                    if ($('[id$=HFFQSelectedItems]').val() == "") {
                        ...
                        result = FQComparision_Customer.GetSelectedItems(FEID);
            ...
            var reslt = FQComparision_Customer.ChecIndividual(RNo, QNo, IsChecked);
            if (reslt.value != '')
                ErrMsg(reslt.value);
        }
        ...
        function CheckAll(id, QNo) {
            ...
            var IsChecked = $('#ch1' + id).is(':checked');
            var reslt = FQComparision_Customer.CheckAll(QNo, IsChecked);
            if (reslt.value != '')
                ErrMsg(reslt.value);
        }
