...
{
    public partial class PurchaseEnquiry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Ajax.Utility.RegisterTypeForAjax(typeof(PurchaseEnquiry));
                        if (!IsPostBack)
                        {
                            ClearAll();
                            ...
                            txtrecvdt.Text = Convert.ToString(DateTime.Now);
        ...
        protected void GetData()
        {
            try
            {
                ...
                if (CommonBLL.CustmrContactTypeText == ((ArrayList)Session["UserDtls"])[7].ToString())
                {
                    ...
                    ddlcustmr.SelectedValue = ((ArrayList)Session["UserDtls"])[12].ToString();
                ...
                if ((string[])Session["UsrPermissions"] != null)// ::VARA Not In Use
                { }
            }
            catch (Exception ex)
            {
        ...
        private void BindReferenceDDL()
        {
            try
            {
                ...
                BindDropDownList(ddlRefForeignEnqNo, NFPOBLL.Select(CommonBLL.FlagGSelect, Guid.Empty, "", Guid.Empty, Guid.Empty, Guid.Empty,
        ...
        protected void ClearAll()
        {
            try
            {
                ...
                EditId = null;
                Session["uploads"] = null;
                ddlcustmr.SelectedIndex = ddlsubject.SelectedIndex = ddldept.SelectedIndex = -1;
                txtenqno.Text = txtimpinst.Text = "";
        ...
        public string FillGridItems(Guid id)
        {
            ...
            HttpContext.Current.Session["ItemsDescPrtNo"] = ItemMstBLl.SelectItemMaster(CommonBLL.FlagXSelect, Guid.Empty, Guid.Empty, new Guid(Session["CompanyID"].ToString()));
            ...
            Thread BThread = new Thread(() => { Thread.CurrentThread.IsBackground = true; });
            //BThread.Start();
        ...
        private void SaveRecord()
        {
            try
            {
                ...
                DataSet ds = NEBLL.SelectFenquiries(CommonBLL.FlagWCommonMstr, Guid.Empty, Guid.Empty, new Guid(ddlcustmr.SelectedValue),
                       DateTime.Now, DateTime.Now, new Guid(Session["UserID"].ToString()), new Guid(Session["CompanyID"].ToString()));
                string PENO = txtPINumber.Text.Trim() + "/" + ds.Tables[0].Rows[0]["HistoryNum"].ToString();
                if (dtt.Rows.Count > 0)
                {
                    ...
                    if (btnSave.Text == "Save" && Request.QueryString["IsAm"] == null && Request.QueryString["IsAm"] != "True")
                        if (CommonBLL.CustmrContactTypeText == (((ArrayList)Session["UserDtls"])[7].ToString()))
                        {
                            res = NEBLL.NewEnquiryInsert(CommonBLL.FlagNewInsert, Guid.Empty, Guid.Empty, CustID, DeptID, txtPINumber.Text.Trim(), CommonBLL.DateInsert(txtPIDate.Text), PENO,
                               ddlsubject.SelectedItem.Text.Trim(), CommonBLL.DateInsert(txtenqdt.Text), CommonBLL.EndDate,
                        ...
                        {
                            res = NEBLL.NewEnquiryInsert(CommonBLL.FlagNewInsert, Guid.Empty, Guid.Empty, CustID, DeptID, txtPINumber.Text.Trim(), CommonBLL.DateInsert(txtPIDate.Text), PENO,
                            ddlsubject.SelectedItem.Text.Trim(), CommonBLL.DateInsert(txtenqdt.Text), CommonBLL.DateInsert(txtrecvdt.Text),
                    ...
                    {
                        string AmdPENO = txtPINumber.Text.Trim() + "/Amend" + ds.Tables[0].Rows[0]["HistoryNum"].ToString();
                        if (CommonBLL.CustmrContactTypeText == (((ArrayList)Session["UserDtls"])[7].ToString()))
                        {

                            res = NEBLL.NewEnquiryInsert(CommonBLL.FlagFSelect, new Guid(Request.QueryString["ID"]), Guid.Empty, CustID, DeptID, txtPINumber.Text.Trim(), CommonBLL.DateInsert(txtPIDate.Text), AmdPENO,
                               ddlsubject.SelectedItem.Text.Trim(), CommonBLL.DateInsert(txtenqdt.Text), CommonBLL.EndDate,
                               CommonBLL.EndDate, txtimpinst.Text.Trim(), Guid.Empty, CommonBLL.StatusTypeFrnEnqID, Attachments, "",
                               new Guid(Session["UserID"].ToString()), new Guid(Session["UserID"].ToString()), true, CmpnyId, dtt, DtSubItems);
                        }
                        ...
                        if (CommonBLL.CustmrContactTypeText == (((ArrayList)Session["UserDtls"])[7].ToString()))
                        {
                            res = NEBLL.NewEnquiryInsert(CommonBLL.FlagUpdate, new Guid(EditId.ToString()), Guid.Empty, CustID, DeptID, txtPINumber.Text.Trim(), CommonBLL.DateInsert(txtPIDate.Text),
                                txtenqno.Text, ddlsubject.SelectedItem.Text.Trim(), CommonBLL.DateInsert(txtenqdt.Text),
        ...
        private void EditRecord(Guid ID)
        {
            try
            {
                ...
                if (EditDS.Tables.Count > 0 && EditDS.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddlsubject.SelectedValue = ddlsubject.Items.FindByText(EditDS.Tables[0].Rows[0]["Subject"].ToString()).Value;
                    if (RefFlag == 0)
                    {
                        EditID = 1;
                        Session["checkstat"] = EditDS.Tables[2];
                        DivComments.Visible = true;
                        txtPINumber.Text = EditDS.Tables[0].Rows[0]["PurchaseIndentNumber"].ToString();
                        ...
                        if (EditDS.Tables[0].Rows[0]["PurchaseIndentDate"].ToString() != "")
                            txtPIDate.Text = CommonBLL.DateDisplay(Convert.ToDateTime(EditDS.Tables[0].Rows[0]["PurchaseIndentDate"].ToString()));
        ...
        private string FillItemGrid(bool ADD)
        {
            try
            {
                ...
                DataSet ds2 = null; DataRow[] drarray = null;
                ...
                if (!ADD)
                {
                    ...
                    //sb.Append("<input type='text'  id='ddl0' value = '' Class='bcAsptextboxmulti_Footer' style='height:20px; width:150px; resize:none;' onchange='FillSpec_ItemDesc(0)'>");
                    //sb.Append("<input type='hidden' id='Item0'/>");
                    ...
                    //                    Parallel.ForEach(dss.Tables[0].AsEnumerable(), drow =>
                    ////                    Parallel.ForEach(Dt.AsEnumerable(), drow =>
                    //                    {
                    //                        Guid ItemID = Guid.Empty;
                    //                        if (!Codes.ContainsValue(new Guid(drow["ID"].ToString())) && new Guid(drow["ID"].ToString()) != ItemID)
                    //                            sb.Append("<option value='" + drow["ID"].ToString() + "'>" + drow["ItemDescription"].ToString() +
                    //                                "</option>");
                    //                        countRow++; // source collection
                    //                    });
                    // Response.Write(DateTime.Now.ToString("hh.mm.ss.ffffff"));
                    ...
                    //Parallel.ForEach(dsUnits.Tables[0].AsEnumerable(), row => { 
        ...
        protected void SendDefaultMails(DataSet ToAdrsTbl, string Type)
        {
            try
            {
                ...
                ToAdrsTbl.Tables[0].Rows[0]["ASSGINEDUSER"].ToString() : ToAdrsTbl.Tables[0].Rows[0]["MNGRMAIL"].ToString());
                    ...
                    string Rslt1 = CommonBLL.SendMails(ToAddrs, CcAddrs.Replace(",,", ","), ddlsubject.SelectedItem.Text.Trim(), InformationEnqDtls());
                }
                else if (Type == "Volta")
                {
                    ...
                    string Rslt1 = CommonBLL.SendMails(ToAddrs, CcAddrs.Replace(",,", ","), ddlsubject.SelectedItem.Text.Trim(), InformationEnqDtls("Volta"));
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
                ...
                || ddlcustmr.SelectedIndex != 0 || ddldept.SelectedIndex != 0)
            {
                ...
                if (res == 0)
                {
                    Response.Redirect("PIStatus.Aspx", false);
                }
            }
        ...
        protected void btnclear_Click(object sender, EventArgs e)
        {
            ClearAll();
            divFEItems.InnerHtml = FillGridItems(Guid.Empty);
            Response.Redirect("PurchaseEnquiry.aspx", false);
        }
        ...
        protected void btnBulkUpload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables.Contains("Items$"))
                    {
                        ...
                        if (dsRtnItms != null && dsRtnItms.Tables.Count > 0)
                        {
                            try
                            {
                                ...
                                {
                                    if (dsRtnItms.Tables[0].Columns.Count == 2 && dsRtnItms.Tables[0].Columns[0].ColumnName == "DuplicateCodes")
                                    {
                                        ...
                                        if (dsRtnItms.Tables[0].Rows[0]["DuplicateCodes"].ToString() != "")
                                            _Msg += string.Format(@"\r\nFile Contains Duplicate Codes: " + dsRtnItms.Tables[0].Rows[0]["DuplicateCodes"].ToString());
                    ...
                    //    //if (dsRtnItms != null && dsRtnItms.Tables.Count > 0)
                    //    //{
                    //    //    ELog.CreateErrorLog(Server.MapPath("../Logs/BulkUpload/ErrorLog"), "Purchase Enquiry Bulk Upload", dsRtnItms.Tables[1].Rows[0][0].ToString().Trim(','));
        ...
        public string NewItemAdded()
        {
            ...
            {
                string Rslt = "";
                Session["ItemsDescPrtNo"] = ItemMstBLl.SelectItemMaster(CommonBLL.FlagXSelect, Guid.Empty, Guid.Empty, new Guid(Session["CompanyID"].ToString()));
                return FillItemGrid(false);
            }
            catch (Exception ex)
            {
        ...
        public static List<string> GetAutoCompleteData(string Txt_Text)
        {
            try
            {
                ...
                var dds = ((DataSet)HttpContext.Current.Session["ItemsDescPrtNo"]).Tables[0];
