...
{
    public partial class PE_Details_Amendment : System.Web.UI.Page
    {
        #region Variables
        Guid ID, CompanyID;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                ELog.CreateErrorLog(Server.MapPath("../Logs/Enquiries/ErrorLog"), "Purchase Enquiry Amendment Details", ex.Message.ToString());
            }
        }
        ...
        protected void GetData()
        {
            try
            {
                ...
                ReportDataSource PeDtlsDSet = new ReportDataSource();
                ReportDataSource PeItmDSet = new ReportDataSource();
                ...
                //else
                //{
                PeDtlsDSet.Name = "vomserpdbDataSet_SP_FFERPTItemDeatails_Amndmnt_Customer";
                PeItmDSet.Name = "vomserpdbDataSet_SP_FERPTAllItemDeatails_Amndmnt_Customer";
                //}
                DataSet dataset = CRPTBLL.GetFenqDetails_Items_Amd(ID, CompanyID);
                ...
                foreach (ReportObject repOp in rptDoc.ReportDefinition.ReportObjects)
                {
                    if (repOp.Kind == ReportObjectKind.SubreportObject)
                    {
                        ...
                        {
                            subRepDoc.Database.Tables[0].SetDataSource(CRPTBLL.GetFenqAllDetails_Items_Amd(ID).Tables[0]);
                        }
                    }
                }
