    ...
    public partial class CommercialInvoiceDetails : System.Web.UI.Page
    {
        ...
        protected void GetData(Guid ID)
        {
            try
            {
                ...
                if (dataset.Tables[0].Rows[0]["CompanyID"].ToString() == Session["CompanyID"].ToString() && dataset.Tables[0].Rows[0]["CompanyName"].ToString().ToLower().Contains("glocem"))
                {
        ...
        private void GenerateHeaderPart(MainDocumentPart mainPart, HeaderPart headerPart)
        {
            try
            {
                ...
                pd3.Append(new Run(new Text("Reverse Charge Applicable:No")));
                pd3.Append(rn5t);
                ...
                col91s.Append(new TableCellProperties(new TableCellWidth() { Type = TableWidthUnitValues.Dxa, Width = "3380" }));
                ...
                col93ss.Append(new TableCellProperties(new TableCellWidth() { Type = TableWidthUnitValues.Dxa, Width = "210" }));
        ...
        //                                               new ParagraphStyleId() { Val = "No Spacing" },
        //                                               new SpacingBetweenLines() { After = "2", Before = "0", AfterLines = 1 },
        //                                               new Justification() { Val = JustificationValues.Right }
        //                                               );
        ...
        private void GenerateBodyPart(MainDocumentPart mainPart, Body body)
        {
            try
            {
               ...
               // tr.TableCell col53 = new tr.TableCell();
                //tr.TableCell col54 = new tr.TableCell();
                //col52b.Append(new Paragraph(new Run(new Text("s"))));
                //row5.Append(col52b);
                //col52.Append(new Paragraph(new Run(new Text("s"))));
                //row5.Append(col52);
                //col53.Append(new Paragraph(new Run(new Text("s"))));
                //row5.Append(col53);

                
                tr.TableCell col52b = new tr.TableCell();
                Paragraph p52bss = new Paragraph();

                Run run52bsz = new tr.Run();
                RunProperties rp52bsz = new RunProperties();
                RunFonts runFont52bsz = new RunFonts();

                ParagraphProperties paragraphProperties52bss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() {Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p52bss.Append(paragraphProperties52bss5sss);
                rp52bsz.FontSize = new tr.FontSize() { Val = "10" };
               // rp52bsz.Bold = new Bold();
                runFont52bsz.Ascii = "Arial";
                rp52bsz.Append(runFont52bsz);
                run52bsz.Append(rp52bsz);
                run52bsz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p52bss.Append(run52bsz);

                //p52bss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col52b.Append(p52bss);
                row5.Append(col52b);


                tr.TableCell col52 = new tr.TableCell();
                Paragraph p52abss = new Paragraph();

                Run run52sz = new tr.Run();
                RunProperties rp52sz = new RunProperties();
                RunFonts runFont52sz = new RunFonts();

                ParagraphProperties paragraphProperties52abss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() { Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p52abss.Append(paragraphProperties52abss5sss);

                rp52sz.FontSize = new tr.FontSize() { Val = "10" };
                //rp52sz.Bold = new Bold();
                runFont52sz.Ascii = "Arial";
                rp52sz.Append(runFont52sz);
                run52sz.Append(rp52sz);
                run52sz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p52abss.Append(run52sz);

                //p52abss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col52.Append(p52abss);
                row5.Append(col52);

                tr.TableCell col53 = new tr.TableCell();
                Paragraph p53abss = new Paragraph();

                Run run53sz = new tr.Run();
                RunProperties rp53sz = new RunProperties();
                RunFonts runFont53sz = new RunFonts();

                ParagraphProperties paragraphProperties53abss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() { Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p53abss.Append(paragraphProperties53abss5sss);

                rp53sz.FontSize = new tr.FontSize() { Val = "10" };
                //rp53sz.Bold = new Bold();
                runFont53sz.Ascii = "Arial";
                rp53sz.Append(runFont53sz);
                run53sz.Append(rp53sz);
                run53sz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p53abss.Append(run53sz);

               // p52abss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col53.Append(p53abss);
                row5.Append(col53);
               ...
               // tr.TableCell col73 = new tr.TableCell();
                ...
                tr.TableCell col72c = new tr.TableCell();
                Paragraph p72cbss = new Paragraph();

                Run run72cbsz = new tr.Run();
                RunProperties rp72cbsz = new RunProperties();
                RunFonts runFont72cbsz = new RunFonts();

                ParagraphProperties paragraphProperties72cbss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() { Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p72cbss.Append(paragraphProperties72cbss5sss);
                rp72cbsz.FontSize = new tr.FontSize() { Val = "10" };
                // rp52bsz.Bold = new Bold();
                runFont72cbsz.Ascii = "Arial";
                rp72cbsz.Append(runFont72cbsz);
                run72cbsz.Append(rp72cbsz);
                run72cbsz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p72cbss.Append(run72cbsz);

                //p52bss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col72c.Append(p72cbss);
                row7.Append(col72c);


                tr.TableCell col72 = new tr.TableCell();
                Paragraph p72abss = new Paragraph();

                Run run72sz = new tr.Run();
                RunProperties rp72sz = new RunProperties();
                RunFonts runFont72sz = new RunFonts();

                ParagraphProperties paragraphProperties72abss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() { Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p72abss.Append(paragraphProperties72abss5sss);

                rp72sz.FontSize = new tr.FontSize() { Val = "10" };
                //rp52sz.Bold = new Bold();
                runFont72sz.Ascii = "Arial";
                rp72sz.Append(runFont72sz);
                run72sz.Append(rp72sz);
                run72sz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p52abss.Append(run72sz);

                //p52abss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col72.Append(p72abss);
                row7.Append(col72);

                tr.TableCell col73 = new tr.TableCell();
                Paragraph p73abss = new Paragraph();

                Run run73sz = new tr.Run();
                RunProperties rp73sz = new RunProperties();
                RunFonts runFont73sz = new RunFonts();

                ParagraphProperties paragraphProperties73abss5sss = new ParagraphProperties(
                                                   new ParagraphStyleId() { Val = "No Spacing" },
                                                   new SpacingBetweenLines() { Before = "0" },
                                                   new Justification() { Val = JustificationValues.Center }
                                                   );
                p73abss.Append(paragraphProperties73abss5sss);

                rp73sz.FontSize = new tr.FontSize() { Val = "10" };
                //rp53sz.Bold = new Bold();
                runFont73sz.Ascii = "Arial";
                rp73sz.Append(runFont73sz);
                run73sz.Append(rp73sz);
                run73sz.Append(new Run(new Text("-") { Space = SpaceProcessingModeValues.Preserve }));
                p73abss.Append(run73sz);

                // p52abss.Append(new Run(new Text("") { Space = SpaceProcessingModeValues.Preserve }));
                col73.Append(p73abss);
                row7.Append(col73);
