<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage.Master" CodeBehind="DispatchShippingDocuments.aspx.cs" Inherits="VOMS_ERP.Invoices.DispatchShippingDocuments" %>
            ...
            <td class="bcTdNewTable">
             <div style="width: 100%">
                <table style="width: 100%; vertical-align: top;" align="center">
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="6">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            &nbsp;&nbsp;&nbsp;<asp:Label ID="lblTitle" runat="server" Text="Dispatch of Shipping Documents"
                            ...
                            <div style="width: 100%">
                                <table>
                                    ...
                                    <td class="bcTdnormal">
                                        ...
                                        <td class="bcTdnormal">
                                            <span class="bcLabel">Airway bill No/Bill of Lading No <font color="red" size="2"><b>
                                            *</b></font>:</span>
                                        </td>
                                        <td class="bcTdnormal">
                    ...
                    <tr>
                    <td>
                            <asp:RadioButton runat="server" ID="InvNumber" Text="Is Received By Courier" GroupName="RdbTest"
                                onclick="ShowHide('1');" />
                                <asp:HiddenField ID="HFInvNo" runat="server" Value="" />
                            <asp:RadioButton runat="server" ID="InvcDate"   Text="Is Received By Person" GroupName="RdbTest" onclick="ShowHide('2');" />
                    ...
                    <tr>
                        <td colspan="6" class="bcTdNewTable" id="Td2">
                            <div style="width: 100%">
                                ...
                                <tr>
                                      <td class="bcTdnormal">
                                            <span class="bcLabel" >Courier Name<font color="red" size="2"><b>
                                            *</b></font> :</span>
                                        </td>
                                    ...
                                    <tr>
                                    <td class="bcTdnormal">
                                            <span class="bcLabel">Courier Sent Date :</span>
                                        </td>
                                       <td class="bcTdnormal" style="width: 185px">
                                    ...
                                    <td class="bcTdnormal">
                                       ...
                                       <td class="bcTdnormal" style="width: 185px">
                                            <asp:TextBox ID="DocumentSentBy" runat="server" CssClass="bcAsptextbox"></asp:TextBox>
                                        </td> 
                                    </tr>
                                    <tr>
                                    <td class="bcTdnormal">
                                    ...
                                    <tr>
                                    <td class="bcTdnormal">
                                            <span class="bcLabel">Received On Date:</span>
                                        </td>   
                                       <td class="bcTdnormal" style="width: 185px">
                                            <asp:TextBox ID="ReceivedOnDate" runat="server" CssClass="bcAsptextbox"></asp:TextBox>
                                        </td> 
                                    </tr>
                                    <tr>
                                </table>
                        ...
                        <td colspan="6" class="bcTdNewTable" id="Td3">
                            <div style="width: 100%">
                                <table>
                                    <tr>
                                      <td class="bcTdnormal">
                                            <span class="bcLabel">Document carrier<font color="red" size="2"><b>
                                            *</b></font>:</span>
                                        </td>
                                        <td class="bcTdnormal" style="width: 185px">
                                    ...
                                    <td class="bcTdnormal">
                                       ...
                                       <td class="bcTdnormal" style="width: 185px">
                                            <asp:TextBox ID="DocumentcarrierContactNo" runat="server" CssClass="bcAsptextbox"></asp:TextBox>
                                        </td> 
                                    </tr>
                                    <tr>
                                    <td class="bcTdnormal">
                                       ...
                                       <td class="bcTdnormal" style="width: 185px">
                                            <asp:TextBox ID="ReceivedPersonCarrier" runat="server" CssClass="bcAsptextbox"></asp:TextBox>
                                        </td> 
                                    </tr>
                                    <tr>
                                    <td class="bcTdnormal">
    ...
    <script type="text/javascript">
        ...
        function Myvalidations() {
            ...
            if ($('[id$=ListBoxAirBillNo]').val() == null) {
                console.log($('#ctl00_ContentPlaceHolder1_ListBoxAirBillNo:selected').length);
                ErrorMessage('AirBillNo is Required.');
                return false;
            }
            else if (res == true) {
                if (($('[id$=CourierName]').val()).trim() == "") {
                    ErrorMessage('Courier Name Required.');
