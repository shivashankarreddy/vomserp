...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr>
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtLeoDt" CssClass="bcAsptextbox DatePicker" TabIndex="6"
                                            onchange="checkDate();" MaxLength="12" required="required"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bcTdnormal" style="display: block">
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtShpngBlNo" onkeypress='return isSomeSplChars(event);'
                                            CssClass="bcAsptextbox" onchange="javascript:return CheckSHPBNo();" TabIndex="8"
                                            MaxLength="50" required="required"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal">
                                ...
                                <tr>
                                    <td class="bcTdnormal" style="display: block">
                                        <span class="bcLabelright">LUT NO :</span>
                                    </td>
                                    <td align="left">
                                        <asp:DropDownList runat="server" ID="ddlLUTARNNo" CssClass="bcAspdropdown" required="required">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="bcTdnormal" style="display: block">
                                        <span class="bcLabelright">Port of Loading :</span>
                                    </td>
                                    <td align="left">
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server" Width="100%">
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox runat="server" CssClass="bcAsptextbox" ID="txtLeoDate"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblScrl" runat="server" Text="DBK Scroll No.:" class="bcLabelright"></asp:Label>
                                                                            <%--<asp:Label ID="lblDBKAmountReceived" runat="server" Text="DBK Amount Received:" class="bcLabelright"></asp:Label>--%>
                                                                            <asp:Label ID="lblrmks" runat="server" Text="Custom Query:" class="bcLabelright"
                                                                        ...
                                                                        <td>
                                                                            <span class="bcLabelright">DBK Scroll Date :</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox runat="server" ID="txtDbkScrolldDt" CssClass="bcAsptextbox DatePicker"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </asp:Panel>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtInvcInr" onblur="extractNumber(this,2,false);"
                                            onkeyup="extractNumber(this,2,false);InvUsd();" onkeypress="return blockNonNumbers(this, event, true, false);" 
                                            CssClass="bcAsptextbox" TabIndex="80" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal">
                                        <span class="bcLabelright">
                                            <asp:Label ID="LblAmount" runat="server" Text="Invoice Value "></asp:Label>
                                            <font color="red" size="2"><b> *</b></font>:</span>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtInvcUsd" onblur="extractNumber(this,2,false);"
                                            onkeyup="extractNumber(this,2,false);FobValInr();" onkeypress="return blockNonNumbers(this, event, true, false);"
                                            CssClass="bcAsptextbox" TabIndex="82" MaxLength="10"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal">
                                        <span class="bcLabelright">
                                            <asp:Label ID="LblFOBVal" Text="FOB Value " runat="server"></asp:Label><font color="red"
                                ...
                                <tr>
                                    <td class="bcTdnormal">
                                        <span class="bcLabelright">
                                            <asp:Label ID="Label2" Text="FOB Value (₹)" runat="server"></asp:Label><font color="red"
                                                size="2"><b></b></font> :</span>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtFobValRup" onblur="extractNumber(this,2,false);"
                                            onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"
                                            CssClass="bcAsptextbox" TabIndex="84" MaxLength="10"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal" style="display: block">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtNtCn" CssClass="bcAsptextbox" required="required"
                                            TabIndex="90" MaxLength="20"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal" style="display: block">
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:TextBox runat="server" ID="txtExcngRt" onblur="extractNumber(this,2,false);"
                                            onkeyup="extractNumber(this,2,false);InvUsd();FobValInr();" onkeypress="return blockNonNumbers(this, event, true, false);"
                                    ...
                                    <td colspan="6">
                                        <table class="rounded-corner" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlInsrncCrncy" onchange="CalculateAmount('ddlInsrncCrncy', 'txtInsrncRt', 'txtInsrncAmnt');FobValInr();"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlFrtCrncy" onchange="CalculateAmount('ddlFrtCrncy', 'txtFrtRt', 'txtFrtAmnt');FobValInr();"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlDscntCrncy" onchange="CalculateAmount('ddlDscntCrncy', 'txtDscntRt', 'txtDscntAmnt');FobValInr();"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlCmsnCrncy" onchange="CalculateAmount('ddlCmsnCrncy', 'txtCmsnRt', 'txtCmsnAmnt');FobValInr();"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlOtrDtcnsCrncy" onchange="CalculateAmount('ddlOtrDtcnsCrncy', 'txtOtrDtcnsRt', 'txtOtrDtcnsAmnt');FobValInr();"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlPkngChrgsCrncy" onchange="CalculateAmount('ddlPkngChrgsCrncy', 'txtPkngChrgsRt', 'txtPkngChrgsAmnt');FobValInr();"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtLetExptDt" CssClass="bcAsptextbox" TabIndex="144"
                                            MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal">
    ...
    <script type="text/javascript">
        ...
        var Freight = document.getElementById('<%= ddlFrtCrncy.ClientID %>');
        Freight.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
        var Insu = document.getElementById('<%= ddlInsrncCrncy.ClientID %>');
        Insu.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
        var Discount = document.getElementById('<%= ddlDscntCrncy.ClientID %>');
        Discount.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
        var Commission = document.getElementById('<%= ddlCmsnCrncy.ClientID %>');
        Commission.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
        var OtherDeductions = document.getElementById('<%= ddlOtrDtcnsCrncy.ClientID %>');
        OtherDeductions.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
        var PackingCharge = document.getElementById('<%= ddlPkngChrgsCrncy.ClientID %>');
        PackingCharge.value = "507b3fa0-076d-4c0f-9732-31d809e48ad6";
    </script>
    <script type="text/javascript">
        ...
        function Myvalidations() {
            try {
                ...
                else if ((($('[id$=txtInvcInr]').val()).trim() == '') || ($('[id$=txtInvcInr]').val() == '0')) {
                    ErrorMessage('Invoice Value is Required.');
                    $('[id$=txtInvcInr]').focus();
                    return false;
                }
                else if (($('[id$=txtInvcUsd]').val()).trim() == '') {
                    ErrorMessage('Invoice Value($) is Required.');
                    $('[id$=txtInvcUsd]').focus();
                    return false;
                }
        ...
        function checkDate() {
            ...
            var LEODate = document.getElementById('<%= txtLeoDt.ClientID %>');
            var DocumentsDate = document.getElementById('<%= txtLetExptDt.ClientID %>');
            var DBKDate = document.getElementById('<%= txtLeoDate.ClientID %>');
            DocumentsDate.value = LEODate.value;
            DBKDate.value = LEODate.value;

        }
        function InvUsd() {
            var txtFirstNumberValue = document.getElementById('<%=txtInvcInr.ClientID%>').value;
            var txtSecondNumberValue = document.getElementById('<%=txtExcngRt.ClientID%>').value;
            if (txtSecondNumberValue == "0") {
                ErrorMessage('Exchange Rate cannot be zero');
                $('[id$=txtExcngRt]').val('');
                $('[id$=txtExcngRt]').focus();
            } else {
                var result1 = parseFloat(txtFirstNumberValue) / parseFloat(txtSecondNumberValue);
                var result = result1.toFixed(2);
                console.log(result1);
                if (!isNaN(result)) {
                    document.getElementById('<%=txtInvcUsd.ClientID%>').value = result;
                    FobValInr();
                }
                else {
                    document.getElementById('<%=txtInvcUsd.ClientID%>').value = " ";
                    FobValInr()
                }
            }
        }
        ...
        //        function FobValInr() {
        //            var txtFirstNumberValue = document.getElementById('<%=txtInvcUsd.ClientID%>').value;
        //            var InsNum = document.getElementById('<%=txtInsrncAmnt.ClientID%>').value;
        //            var FrtNum = document.getElementById('<%=txtFrtAmnt.ClientID%>').value;
        //            var Disnum = document.getElementById('<%=txtDscntAmnt.ClientID%>').value;
        //            var CsmnNum = document.getElementById('<%=txtCmsnAmnt.ClientID%>').value;
        //            var othNum = document.getElementById('<%=txtOtrDtcnsAmnt.ClientID%>').value;
        //            var PkngChrgsNum = document.getElementById('<%=txtPkngChrgsAmnt.ClientID%>').value;
        //            var result1 = txtFirstNumberValue - InsNum - FrtNum - Disnum - CsmnNum - othNum - PkngChrgsNum
        //            var result = result1.toFixed(2);
        //            if (isNaN(txtFirstNumberValue)) {
        //                document.getElementById('<%=txtFobValInr.ClientID%>').value = "";
        //            }
        //            else if (result < 0) {
        //                ErrorMessage('Total Exceeding FOB Value($)')
        //                $('[id$=txtInsrncAmnt]').val('');
        //                $('[id$=txtFrtAmnt]').val('');
        //                $('[id$=txtDscntAmnt]').val('');
        //                $('[id$=txtCmsnAmnt]').val('');
        //                $('[id$=txtOtrDtcnsAmnt]').val('');
        //                $('[id$=txtPkngChrgsAmnt]').val('');
        //                document.getElementById('<%=txtFobValInr.ClientID%>').value = txtFirstNumberValue;
        //            }
        //            else if (result > 0 || result == 0) {
        //                document.getElementById('<%=txtFobValInr.ClientID%>').value = result;
        //            }
        //            if (!isNaN(InsNum)) {
        ...
        function FobValInr() {
            ...
            var txtFirstNumberValue = document.getElementById('<%=txtInvcUsd.ClientID%>').value;
            var txtSecondNumberValue1 = document.getElementById('ctl00_ContentPlaceHolder1_txtExcngRt').value
           
            if (($('[id$=ddlInsrncCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var InsNum2 = document.getElementById('<%=txtInsrncAmnt.ClientID%>').value;
                var InsNum = (InsNum2 / txtSecondNumberValue1);
            } else {
                var InsNum = document.getElementById('<%=txtInsrncAmnt.ClientID%>').value;
            }
            if (($('[id$=ddlFrtCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var FrtNum2 = document.getElementById('<%=txtFrtAmnt.ClientID%>').value;
                var FrtNum = (FrtNum2 / txtSecondNumberValue1);
            } else {
                var FrtNum = document.getElementById('<%=txtFrtAmnt.ClientID%>').value;
            }
            if (($('[id$=ddlDscntCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var Disnum2 = document.getElementById('<%=txtDscntAmnt.ClientID%>').value;
                var Disnum = (Disnum2 / txtSecondNumberValue1);
            } else {
                var Disnum = document.getElementById('<%=txtDscntAmnt.ClientID%>').value;
            }
            if (($('[id$=ddlCmsnCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var CsmnNum2 = document.getElementById('<%=txtCmsnAmnt.ClientID%>').value;
                var CsmnNum = (CsmnNum2 / txtSecondNumberValue1);

            } else {
                var CsmnNum = document.getElementById('<%=txtCmsnAmnt.ClientID%>').value;
            }
            if (($('[id$=ddlOtrDtcnsCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var othNum2 = document.getElementById('<%=txtOtrDtcnsAmnt.ClientID%>').value;
                var othNum = (othNum2 / txtSecondNumberValue1);
            } else {
                var othNum = document.getElementById('<%=txtOtrDtcnsAmnt.ClientID%>').value;
            } if (($('[id$=ddlPkngChrgsCrncy]').val()).trim() == '6c006acf-338e-410a-89cd-dcec46b4a0e9') {
                var PkngChrgsNum2 = document.getElementById('<%=txtPkngChrgsAmnt.ClientID%>').value;
                var PkngChrgsNum = (PkngChrgsNum2 / txtSecondNumberValue1);
            } else {
                var PkngChrgsNum = document.getElementById('<%=txtPkngChrgsAmnt.ClientID%>').value;
            }
            //                var FrtNum2 = document.getElementById('<%=txtFrtAmnt.ClientID%>').value;
            ...
            if (isNaN(txtFirstNumberValue)) {
                ...
                $('[id$=txtDscntRt]').val('');
                $('[id$=txtCmsnRt]').val('');
                $('[id$=txtOtrDtcnsRt]').val('');
                $('[id$=txtPkngChrgsRt]').val('');
                $('[id$=ddlInsrncCrncy]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                $('[id$=ddlFrtCrncy ]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                $('[id$=ddlDscntCrncy]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                $('[id$=ddlCmsnCrncy]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                $('[id$=ddlOtrDtcnsCrncy]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                $('[id$=ddlPkngChrgsCrncy]').val('507b3fa0-076d-4c0f-9732-31d809e48ad6');
                document.getElementById('<%=txtFobValInr.ClientID%>').value = txtFirstNumberValue;
            }
            else if (result > 0 || result == 0) {
                document.getElementById('<%=txtFobValInr.ClientID%>').value = result;
