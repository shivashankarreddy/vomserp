<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Home.aspx.cs" Inherits="VOMS_ERP.Masters.Home"  %> <%--Title="Volta Impex Pvt Ltd"--%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="MainTable" align="center">
        ...
        <tr>
            <td class="bcTdnormal" style= "text-align:center; font-size:xx-large; color:Blue;">
          
            <div>
            </div>
                <div id="full_dashbord" visible = "false" class="full_dashbord" style="margin-top: 10px; margin-bottom: 20px; visibility: hidden">
                 ...
                 <asp:Label ID="Label2" runat="server" Text = "WELCOME TO VOMS" ></asp:Label></span></a>
                <div id="full_dashbord0" visible = "false" class="full_dashbord" style="margin-top: 10px; margin-bottom: 20px; visibility:hidden">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
                ...
                <div id="full_dashbord3" visible = "false" class="full_dashbord" style="margin-top: 10px; margin-bottom: 20px; visibility:hidden">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
                ...
                <div id="full_dashbord1" class="full_dashbord" style="margin-top: 10px; margin-bottom: 20px; visibility:hidden">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
                ...
                <div id="full_dashbord2" class="full_dashbord" style="margin-top: 10px; margin-bottom: 20px; visibility: hidden">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
