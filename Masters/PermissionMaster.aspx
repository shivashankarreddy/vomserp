<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="PermissionMaster.aspx.cs" Inherits="VOMS_ERP.Masters.PermissionMaster"
     %>
                ...
                <table style="width: 98%; vertical-align: top" align="center">
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="3">
                            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Permission Master"
                    ...
                    <tr>
                        <td style="text-align: right;" class="bcTdnormal">
                            <font color="red" size="4"><b>*</b></font><span id="Label13" class="bcLabelright">Permission
                                Description:</span>
                        </td>
                        <td>
                            &nbsp;
                        ...
                        <td class="bcTdnormal">
                            <asp:TextBox runat="server" ID="txtPmsnDscrp" MaxLength="250" class="bcAsptextbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" class="bcTdNewTable">
                            <div id="dvEnmMstr" class="DivGridSize">
                                <center>
                                    <asp:GridView runat="server" ID="gvPmsnMstr" AutoGenerateColumns="False" RowStyle-CssClass="bcGridViewRowStyle"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Permission Description" DataField="Department Name" HeaderStyle-Width="170px" />
