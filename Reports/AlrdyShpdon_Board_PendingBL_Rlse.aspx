<%@ Page  Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="AlrdyShpdon_Board_PendingBL_Rlse.aspx.cs" Inherits="VOMS_ERP.Reports.AlrdyShpdon_Board_PendingBL_Rlse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="MainTable" align="center">
        <tr>
            <td class="bcTdNewTable">
                                ...
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="lblTitle" runat="server" style="font-size:15.5px;font-weight:bold"
                                         Text="STATEMENT OF CARGO - ALREADY SHIPPED ON BOARD / PENDING BILL OF LADING RELEASES - AS ON Dt."
                ...
                <table id="gvAlrdyShpOn_Board_Pdng_BL_Rlse" class="widthFull fontsize10 displayNone"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvAlrdyShpOn_Board_Pdng_BL_Rlse]").dataTable({
                "oLanguage": {
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "ReportService.asmx/AlrdyShpdOnBoard_Pending_BL_Rlse",
                "bJQueryUI": true,
                    ...
                    $.ajax({
                        ...
                        "success":
                                function (msg) {
                                    ...
                                    fnCallback(json);
                                    $("#gvAlrdyShpOn_Board_Pdng_BL_Rlse").show();
                                }
                    });
                }
            });
            $("#gvAlrdyShpOn_Board_Pdng_BL_Rlse").dataTable().columnFilter(
                {
            ...
            /* Init the table */
            oTable = $("#gvAlrdyShpOn_Board_Pdng_BL_Rlse").dataTable();
        });
    </script>
</asp:Content>
