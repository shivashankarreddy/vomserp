...
{
    /// <summary>
    /// Summary description for StatusofFpo1
    /// </summary>
    public class StatusofFpo1 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                res = FEBLL.VUpdateEnqiryHead(CommonBLL.FlagHSelect, FPOID,new Guid(context.Session["UserID"].ToString()), IsCancel_Hold, Remarks);
                if (res == 0)
