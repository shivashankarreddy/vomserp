...
{
    public partial class INVsforEPSBsPending : System.Web.UI.Page
    {
        # region variables
        ...
        protected void btnExcelExpt_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                DataSet ds = RPBL.Export_INVsforEPSBsPending(INVOICE_No, INVOICE_FromDate, INVOICE_ToDate, PACKING_No, PKNG_LIST_FromDate, PKNG_LIST_ToDate,
                    AWB_BL_No, AWB_BL_FromDate, AWB_BL_ToDate, SBILL_No, Sb_FromDate, Sb_ToDate, PORT, CIF_AMOUNT, FRIEGHT, FOB_VALUE, NAME_OF_THE_PARTY, "", new Guid(Session["CompanyID"].ToString())); // TO_PORT);
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    string MTitle = " LIST OF INVOICES FOR WHICH EP COPIES OF SHIPPING BILLS HAVE NOT BEEN RECEIVED ", MTDTS = "";
