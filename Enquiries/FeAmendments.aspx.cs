...
{
    public partial class FeAmendments : System.Web.UI.Page
    {
        # region variables
        int res;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                Ajax.Utility.RegisterTypeForAjax(typeof(FeAmendments));  
            ...
            catch (Exception ex)
            {
                ...
                ELog.CreateErrorLog(Server.MapPath("../Logs/Enquiries/ErrorLog"), "Enquiry Amendment Status", ex.Message.ToString());
            }
        }
