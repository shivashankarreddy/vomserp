<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FeStatusOverView.aspx.cs" Inherits="VOMS_ERP.Enquiries.FeStatusOverView" %>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <table id="tblFeStatOverView" cellpadding="0" cellspacing="0" border="0" class="display">
                                            <thead>
                                                <tr>
                                                    <th width="5%">
                                                        Customer
                                ...
                                <tr>
                                    <td>
                                        <div style="background-color: White; float: left; padding-top: 10px; width: 100%;
                                            display: none; border: Solid 1px black; min-height: 100px; max-height: 400px;
                                            overflow: auto;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#tblFeStatOverView').dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "WebService1.asmx/GetFeOverview",
            ...
            $("#tblFeStatOverView").dataTable().columnFilter(
                {
                    "aoColumns": [
                                    { "type": "text" },
                                    { "type": "date-range" },
