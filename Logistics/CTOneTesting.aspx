<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="CTOneTesting.aspx.cs" Inherits="VOMS_ERP.CTOneTesting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div style="width: 100%">
                    ...
                    <table width="98%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc"
                        ...
                        <tr>
                            ...
                            <td class="bcTdnormal">
                                <asp:DropDownList runat="server" ID="ddlIOMRefNo" CssClass="bcAspdropdown" Height="22px"
                                    ...
                                    <%-- <asp:ListItem Value="0" Text="Select IOM Ref No"></asp:ListItem>--%>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td class="bcTdnormal">
                                <asp:ListBox runat="server" ID="ListBoxFPO" CssClass="bcAspMultiSelectListBox">
                                    <%--OnPreRender="ListBoxFPO_PreRender"--%>
                                </asp:ListBox>
                            </td>
                            <td>
                            ...
                            <td class="bcTdnormal">
                                <asp:ListBox runat="server" ID="ListBoxLPO" CssClass="bcAspMultiSelectListBox">
                                    <%--OnPreRender="ListBoxLPO_PreRender"--%>
                                </asp:ListBox>
                            </td>
                            <td class="bcTdnormal">
                        ...
                        <tr>
                            <td colspan="6" class="bcTdNewTable">
                                ...
                                <div id="DivItemDetails" runat="server" style="overflow: auto; width: 100%;">
                                </div>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <table style="width: 100%; overflow: auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%--OnTextChanged="txtDsnt_TextChanged" AutoPostBack="true"--%>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div id="dvPkng" style="display: none;">
                                                    <asp:TextBox runat="server" ID="txtPkng" CssClass="bcAsptextbox" onblur="extractNumber(this,2,false);"
                                                        onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"
                                                        Width="35px" MaxLength="5" onchange="Calculate();"></asp:TextBox>%</div>
                                                <%--OnTextChanged="txtPkng_TextChanged"  AutoPostBack="true"--%>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div id="dvExdt" style="display: none;">
                                                    <asp:TextBox runat="server" ID="txtExdt" CssClass="bcAsptextbox" onblur="extractNumber(this,2,false);"
                                                        onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"
                                                        Width="35px" MaxLength="5" onchange="Calculate();"></asp:TextBox>%</div>
                                                <%--OnTextChanged="txtExdt_TextChanged" AutoPostBack="true"--%>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <table width="98%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc"
                        ...
                        <tr>
                            ...
                            <td class="bcTdnormal">
                                <span class="bcLabel">Material Dispatch Date<font color="red" size="2"><b>*</b></font>:</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="bcTdnormal">
                                <asp:DropDownList runat="server" ID="ddlHypothecation" CssClass="bcAspdropdown" Height="22px"
                                    ...
                                    <asp:ListItem Value="0" Text="Select Hypothecation"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="bcTdnormal">
                            ...
                            <td class="bcTdnormal">
                                <asp:DropDownList runat="server" ID="ddlUnits" CssClass="bcAspdropdown" AutoPostBack="True"
                                    ...
                                    <asp:ListItem Value="0" Text="Select Units"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="bcTdnormal">
                        ...
                        <tr>
                            <%-- <td class="bcTdnormal">
                                <span class="bcLabel">CT-1 Dispatch Date <font color="red" size="2"><b></b></font>:</span>
                            </td>
                            <td class="bcTdnormal" style="width: 215px">
                                <asp:TextBox runat="server" ID="txtct1DispatchDT" CssClass="bcAsptextbox"></asp:TextBox>
                            </td>--%>
                            <td class="bcTdnormal">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtBondBalance" MaxLength="12" CssClass="bcAsptextbox"
                                    onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"
                                    onchange="CheckBondBalaceVal()"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="bcTdnormal" style="width: 215px">
                                <asp:TextBox runat="server" ID="txtCtOneVal" CssClass="bcAsptextbox" onkeyup="extractNumber(this,2,false);"
                                    MaxLength="12" onkeypress="return blockNonNumbers(this, event, true, false);"
                                    onchange="CheckBondBalaceVal()"></asp:TextBox>
                            </td>
                            <td class="bcTdnormal">
                            ...
                            <td class="bcTdnormal">
                                <asp:TextBox runat="server" ID="txtRefNo" onchange="GetCTOneRefNo()" CssClass="bcAsptextbox"
    ...
    <script type="text/javascript">
        ...
        function GetCTOneInternalRefNo() {
            ...
            var result = CTOneTesting.GetCTOneInternalRefNo(refNo);
        ...
        function CheckECC() {
            ...
            var result = CTOneTesting.CheckECC(refNo);
            if (result.value == false) {
                $('[id$=txtECCNo]').val('');
                $('[id$=txtECCNo]').focus();
        ...
        function GetCTOneRefNo() {
            //            var refNo = $('[id$=txtRefNo]').val();
            //            var result = CTOneTesting.GetCTOneRefNo(refNo);
            //            if (result.value == false) {
            //                $('[id$=txtRefNo]').val('');
            //                $('[id$=txtRefNo]').focus();
        ...
        function CheckBondBalaceVal() {
            //            var BondBalVal = parseInt($('[id$=txtBondBalance]').val());
            //            if (isNaN(BondBalVal) || BondBalVal == '') {
            //                BondBalVal = 0;
            //                $('[id$=txtBondBalance]').val('0');
            //            }
            //            var CTOneVal = parseInt($('[id$=txtCtOneVal]').val());
            //            if (CTOneVal > BondBalVal) {
            //                $('[id$=txtCtOneVal]').val('');
            //                ErrorMessage('Bond Balance Value Cannot be Less than CT-1 value.');
            //            }
        }

        $('[id$=txtCtOneVal]').keyup(function (e) {
            //            var BondBalVal = parseInt($('[id$=txtBondBalance]').val());
            //            if (isNaN(BondBalVal) || BondBalVal == "") {
            //                BondBalVal = 0;
            //                $('[id$=txtBondBalance]').val('0');
        ...
        function uploadComplete() {
            var result = CTOneTesting.AddItemListBox();
        ...
        $('#lnkdelete').click(function () {
            if ($('#lbItems').val() != "") {
                var result = CTOneTesting.DeleteItemListBox($('#lbItems').val());
                var getDivctoneItems = GetClientID("divListBox").attr("id");
                $('#' + getDivctoneItems).html(result.value);
                var listid = GetClientID("lbItems").attr("id");
                $('#' + listid)[0].selectedIndex = '0';
    ...
    <script type="text/javascript">
        ...
        function ExpandTXTt(obj) {
            $('#txtDesc-Specc' + obj + 'a' + obj).animate({ "height": "75px" }, "slow");
            $('#txtDesc-Specc' + obj + 'a' + obj).slideDown("slow");
        }

        function ReSizeTXTt(obj) {
            $('#txtDesc-Specc' + obj + 'a' + obj).animate({ "height": "20px" }, "slow");
            $('#txtDesc-Specc' + obj + 'a' + obj).slideDown("slow");
        }
        ...
        function GetItemDesc_Spec(ItmID, id) {
            var rslt = CTOneTesting.GetItemDesc_Spec(ItmID);
        ...
        function Calculate() {
            ...
            if (DscntAll == '' || PkngAll == '' || ExseAll == '' || ChkDsnt || ChkPkng || ChkExse) {
                result = CTOneTesting.Calculations(ExseAll, DscntAll, PkngAll, ChkDsnt, ChkExse, ChkPkng);
                //}
        ...
        function UpdateItems(RNo) {
            ...
            if (txtSpec == '' || txtqty == '' || txtExDuty == '' || txtPckngPrcnt == '' || txtDscnt == '' || txtHSCode == '') {
                ...
                var result;
                if (ChkDsnt || ChkPkng || ChkExse) {
                    result = CTOneTesting.SaveChanges(RNo, SNo, txtSpec, txtqty, txtExDuty, txtPckngPrcnt, txtDscnt, txtHSCode);
                    result = CTOneTesting.Calculations(ExseAll, DscntAll, PkngAll, ChkDsnt, ChkExse, ChkPkng);
                }
                else {
                    result = CTOneTesting.SaveChanges(RNo, SNo, txtSpec, txtqty, txtExDuty, txtPckngPrcnt, txtDscnt, txtHSCode);
        ...
        function CheckChaild(RNo) {
            ...
            var result = CTOneTesting.ChkBoxChecked(RNo, ChkStatus);
            var getDivLQItems = GetClientID("DivItemDetails").attr("id");
            $('#' + getDivLQItems).html(result.value);
            footerValues();
        ...
        function CheckHeader() {
            ...
            var result = CTOneTesting.CheckHeader(ChkStatus);
            var getDivLQItems = GetClientID("DivItemDetails").attr("id");
            $('#' + getDivLQItems).html(result.value);
            footerValues();
        }     
    ...
    <script type="text/javascript">
        ...
        function Myvalidations() {
            //            if (accordion == null)
            //                accordion = $find('UserAccordion_AccordionExtender');
            //accordion.set_SelectedIndex(0);
                ...
                if (isChecked) {
                    ...
                    if (qty == 0 || qty == '' || (ExDuty == 0 && ExDutyPercent == 0) || HsCode == '') {
                        ...
                        if (HsCode == 0) {
                            ...
                            message = 'If CheckBox is checked Ex-Duty has to be entererd either in that Row : ' + i + ' or in Terms & Conditions.';
                            $('#txtExDuty' + '' + i).focus();
                        }
            ...
            if (($('[id$=ddlIOMRefNo]').val()).trim() == '0' && ($('[id$=HFPrfINVID]').val()).trim() == '') {
                //$('[id$=ddlIOMRefNo]').focus();
                ErrorMessage('Please Select IOM Ref No./Proforma INVOICE ID');
                return false;
            }
            //            if (($('[id$=txtSubject]').val()).trim() == '') {
            //                //accordion.set_SelectedIndex(0);
            //                $('[id$=txtSubject]').focus();
            ...
            //            else if (($('[id$=txtExRegNo]').val()).trim() == '') {
            //                //accordion.set_SelectedIndex(0);
            //                $('[id$=txtExRegNo]').focus();
            ...
            //            }
                ...
                ErrorMessage('Commission Address is Required.');
                return false;
            }
            //            else if (($('[id$=txtDutyDrawBackNo]').val()).trim() == '') {
            //                //accordion.set_SelectedIndex(0);
            //                $('[id$=txtDutyDrawBackNo]').focus();
            //                ErrorMessage('Duty Drawback No. is Required.');
            //                return false;
            //            }
            else if (($('[id$=txtDispatchMdt]').val()).trim() == '') {
                //accordion.set_SelectedIndex(0);
                $('[id$=txtDispatchMdt]').focus();
                ErrorMessage('Dispath Material Date is Required.');
                return false;
            }
            //            else if (($('[id$=txtMaterlGatePass]').val()).trim() == '') {
            //                //accordion.set_SelectedIndex(0);
            //                $('[id$=txtMaterlGatePass]').focus();
            //                ErrorMessage('Material Gatepass & Invoice is Required.');
            //                return false;
            //            }
            ...
            else if (($('[id$=ddlLocation]').val()).trim() == '0') {
            ...
            if (rowCount == 0) {
                ...
                var result = CTOneTesting.Validate_SubItem_BeforeSaving();
                if (result.value != "") {
    ...
    <script type="text/javascript">
        ...
        $('[src*=expand]').live('click', function (e) {
            ...
            if ($('[id$=ckhChaild' + TRid + ']').is(':checked')) {
                var NewTbl = CTOneTesting.Expand_LPOs(LPOID, ItemID, TRid);
                //NewTbl.hide();
        ...
        function Add_Sub_Itms1(TrID, RowID, ClickRID, RowIndex, IsAdd) {
            //LPOID, ItemId, TRid, ItmDesc, HSCode, Qty, Rate, Disc, Pkng, exduty, DiscPercent, PkngPercent, ExDutyPercent
            ...
            if (IsAdd == true) {
                if (ItemID.trim() == "" || ItemID.trim() == 0) {
                    ...
                    var res;
                    res = CTOneTesting.Add_Sub_Itms(RowID, TrID, SubRowID, LPOID, ParentItemID, ItemID, FESNo, LPONo, ItmDetailsID, ItmDesc, HSCode, Qty, Rate, Disc, Pkng, exduty, UnitsID, DiscPercent, PkngPercent, ExDutyPercent, IsAdd);
                    if (ChkDsnt || ChkPkng || ChkExse) {
                        res = CTOneTesting.Calculations_Sub(ExseAll, DscntAll, PkngAll, ChkDsnt, ChkExse, ChkPkng, LPOID, LPONo, ParentItemID, TrID, IsAdd);
                    }
                    $(".DEL" + TrID).remove();
        ...
        //string LPOID, string ParentItemId, string TRid, string SNo
        function Delete_SubItem(TrID, SNo, x) {
            if (confirm("Are you sure you want to Delete?")) {
                ...
                var ParentItemID = $('#HFItemID' + TrID).val();
                var ItemID = $('#hfSubItemID' + ClickRID).val();
                var res = CTOneTesting.Delete_SubItem(LPOID, ParentItemID, TrID, SNo, ItemID);
                $(".DEL" + TrID).remove();
