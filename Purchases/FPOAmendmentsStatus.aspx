<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FPOAmendmentsStatus.aspx.cs" Inherits="VOMS_ERP.Purchases.FPOAmendmentsStatus" %>
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Foreign Purchase Order Amendment Status"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvItmMstr]").dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "Purchases_WebService.asmx/GetFPOAmendmentsItems",
                "bJQueryUI": true,
