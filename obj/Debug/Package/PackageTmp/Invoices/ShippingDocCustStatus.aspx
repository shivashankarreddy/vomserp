...
CodeBehind="ShippingDocCustStatus.aspx.cs" Inherits="VOMS_ERP.Invoices.ShippingDocCustStatus" %>
                ...
                <tr class="bcTRTitleRow">
                    <td class="bcTdTitleLeft" align="left" colspan="6">
                        <table width="100%">
                            <tr>
                                <td>
                                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Shipping Documents Customer Status"
                    ...
                    <td>
                        ...
                        <asp:HiddenField ID="HFUnit" runat="server" Value="" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvShipCustDoc]").dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "ShipDocCust.asmx/GetShipDocCustStatus",
        ...
        function EditDetails(valddd, CreatedBy, IsCust, SDCId) {
            try {
                var result = ShippingDocCustStatus.EditItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                var fres = result.value;
                if (fres == 'Success') {
                    window.location.replace("../Invoices/ShippingDocumentsCustomer.aspx?ID=" + SDCId);  //valddd.parentNode.parentNode.id);
                }
                else {
                    ErrorMessage(fres);
                }
        ...
        function Delet(valddd, CreatedBy, IsCust, SDCId) {

            try {
                if (confirm("Are you sure you want to Delete?")) {
                    var result = ShippingDocCustStatus.DeleteItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust, SDCId);
                    var fres = result.value;
                    if (fres == 'Success') {
                        oTable.fnDraw();
