<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="FloatedEnquiryStatus.aspx.cs" Inherits="VOMS_ERP.Enquiries.FloatedEnquiryStatus" %>
            ...
            <td class="bcTdNewTable">
                <table width="100%">
                    <tr class="bcTRTitleRow">
                        <td>
                            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Floated Foreign Enquiry Status"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#tblOscarNominees').dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "WebService1.asmx/GetFFEItems",
        ...
        function mailsDetails(valddd) {
            try {
                window.location.replace("../Masters/EmailSend.aspx?FFeID=" + valddd.parentNode.parentNode.id);
            } catch (e) {
                alert(e.Message);
            }
        }
        function EditDetails(valddd, CreatedBy, IsCust) {
            try {
               // var result = FEStatus.EditItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                ...
                //if (fres == 'Success') {
                    window.location.replace("../Enquiries/FloatEnquiryVendor.Aspx?ID=" + valddd.parentNode.parentNode.id);
                }
        ...
        function Delet(valddd, CreatedBy, IsCust) {
            try {
                if (confirm("Are you sure you want to Delete?")) {
                    var result = FloatedEnquiryStatus.DeleteItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                    var fres = result.value;
