...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td>
        <table width="100%">
            <tr>
                <td>
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="lblTitle" runat="server" Text="Foreign Enquiry Stage"
                        ...
                        <Panes>
                            <ajax:AccordionPane ID="AccordionPane1" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblFENo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane2" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Local Enquiry</a>
                                    <asp:Label ID="lblLENo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane3" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Local Quotation</a>
                                    <asp:Label ID="lblLQNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane4" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Foreign Quotation</a>
                                    <asp:Label ID="lblFQNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane5" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblFPONos" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label></Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane6" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblLPONos" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
...
<%--
                            ...
                            <ajax:AccordionPane ID="AccordionPane8" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Inspection</a>
                                    <asp:Label ID="lblInsNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane9" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Drawings</a>
                                    <asp:Label ID="lblDrNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane12" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Proforma Invoice Request</a>
                                    <asp:Label ID="lblPIRNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane13" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">IOM (Inter Office Memo) Template</a>
                                    <asp:Label ID="lblIOMTNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
...
--%>
                            <ajax:AccordionPane ID="AccordionPane11" runat="server">
                                <Header>
                                    <a href="javascript:void(0)" class="href">Dispatch Instructions</a>
                                    <asp:Label ID="lblDINo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                    </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane14" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblGRNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane15" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblSPDNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane16" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblSPINo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane17" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblPLNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane22" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblSBDNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane18" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblABNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane19" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblBLNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane20" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblMRNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
                            ...
                            <ajax:AccordionPane ID="AccordionPane21" runat="server">
                                <Header>
                                    ...
                                    <asp:Label ID="lblEBRNo" runat="server" Text="" ForeColor="white" CssClass="singlepageLabel"></asp:Label>
                                </Header>
                                <Content>
