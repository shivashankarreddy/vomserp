<%@ Page  Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Gated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing.aspx.cs"
    Inherits="VOMS_ERP.Reports.Gated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing" %>
...
<table class="MainTable" align="center">
        <tr>
            <td class="bcTdNewTable">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        ...
                                        Text="STATEMENT OF CARGO - GATED INTO SEA PORT / AWAITING SOB CONFIRMATION / VESSEL SAILING"
                ...
                <table id="gvGated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing" class="widthFull fontsize10 displayNone"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvGated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing]").dataTable({
                "oLanguage": {
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "ReportService.asmx/Gated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing",
                "bJQueryUI": true,
                    ...
                    $.ajax({
                        ...
                        "success":
                                function (msg) {
                                    ...
                                    fnCallback(json);
                                    $("#gvGated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing").show();
                                }
                    });
                }
            });
            $("#gvGated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing").dataTable().columnFilter(
                {
            ...
            /* Init the table */
            oTable = $("#gvGated_into_Sea_Port_Awating_SOB_Confirmation_Vessel_Sailing").dataTable();
        });
    </script>
