<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="LQComparisionByItems.aspx.cs" Inherits="VOMS_ERP.Quotations.LQComparisionByItems"
     %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Local Quotation Comparison Statement"
    ...
    <script type="text/javascript">
        ...
        function CheckAll1(id, CNO) {
                ...
                if (rowCount > 2) {
                    ...
                    for (var i = 3; i <= rowCount - 4; i++) {
                        ...
                        if (ItmStatus != "" && typeof(ItmStatus) != 'undefined') {
                            if ($('#' + ElmntID + (i -3) + '').length > 0 && $('#' + ElmntID + (i - 3) + '').css('display') != 'none' && ItmStatus <= 50)//60 previous commented  **Latest//40 
            ...
            var result = LQComparisionByItems.CheckHeader(CNO, IsChecked);
        }
        ...
        function CheckInd(CID, RNO, SupID) {
            ...
            var result = LQComparisionByItems.CheckInd(RNO, SupID, IsCheckedMain);
            ...
            if (IsCheckedMain && result.value == "Checked")
                ...
                $('#' + ElmntID).attr('checked', false);
                if (ItmStatus > 50) { //40 changed by dinesh need to check if any issues occurs
