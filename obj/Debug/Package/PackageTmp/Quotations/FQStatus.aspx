<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="FQStatus.aspx.cs" Inherits="VOMS_ERP.Quotations.FQStatus" EnableEventValidation="false"
     %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#FQStatus').dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "Quotations_WebService.asmx/GetFQItems",
                ...
                "oLanguage": {
                    ...
                    "sInfo": "Displaying _START_ to _END_", // of_TOTAL_ records
        ...
        function mailsDetails(valddd) {
            try {
                ...
                window.location.replace("../Masters/EmailSend.aspx?FqID=" + valddd.parentNode.parentNode.id);
            } catch (e) {
                alert(e.Message);
            }
        }
        function EditDetails(valddd, CreatedBy, IsCust, Status) {
            try {
                ...
                if (Status == 60) {
                    ...
                    var result = FQStatus.EditItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust, Status);
                    var fres = result.value;
                    if (fres == 'Success') {
                        window.location.replace("../Quotations/NewFQuotation.Aspx?ID=" + valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                    }
                    else {
                        ErrorMessage(fres);
                    }
        ...
        function Delet(valddd, CreatedBy, IsUser) {
            try {
                if (confirm("Are you sure you want to Delete?")) {
                    var result = FQStatus.DeleteItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsUser);
                    var fres = result.value;
