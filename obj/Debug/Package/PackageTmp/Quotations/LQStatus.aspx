<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="LQStatus.aspx.cs" Inherits="VOMS_ERP.Quotations.LQStatus"
     %>
    ...
    <table class="MainTable" align="center">
        ...
        <tr>
            <td>
                ...
                <asp:HiddenField ID="HFRefLeNmbr" runat="server" Value="" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvLqItems]").dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "Quotations_WebService.asmx/GetLQItems",
                "bJQueryUI": true,
        ...
        function mailsDetails(valddd) {
            try {
                ...
                window.location.replace("../Masters/EmailSend.aspx?LQID=" + valddd.parentNode.parentNode.id);
            } catch (e) {
                alert(e.Message);
            }
        }
        function EditDetails(valddd) {
            try {
                ...
                window.location.replace("../Quotations/NewLQuotation.Aspx?ID=" + valddd.parentNode.parentNode.id);
            } catch (e) {
                alert(e.Message);
            }
        }
        ...
        function Delet(valddd) {
            try {
                if (confirm("Are you sure you want to Delete?")) {
                    var result = LQStatus.DeleteItemDetails(valddd.parentNode.parentNode.id);
