<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="LConfromationBasket.aspx.cs" Inherits="VOMS_ERP.Quotations.QotConfromationBasket"
     %>
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="6">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="lblTitle" runat="server" Text="Local Quotation Confirmation Basket"
                            ...
                            <tr valign="middle">
                                <td align="center" valign="middle" class="bcTdButton">
                                    <div id="Div1" class="bcButtonDiv">
                                        <asp:LinkButton runat="server" ID="btnSave" Text="Confirm" OnClientClick="javascript:Myvalidations()"
                                ...
                                <td align="center" valign="middle" class="bcTdButton">
                                    <div id="Div4" class="bcButtonDiv">
                                        <asp:LinkButton runat="server" ID="btnFpoSave" Visible="false" Text="Confirm with FPO"
