...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="date_range_filter" id="' + sFromId + '" rel="' + i + '" title="From Date"/>');
            from.datepicker({ changeMonth: true, changeYear: true });
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="date_range_filter" id="' + sToId + '" rel="' + i + '" title="To Date"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
        ...
        return this.each(function () {
            ...
            aoFilterCells = oTable.fnSettings().aoFooter[1];
