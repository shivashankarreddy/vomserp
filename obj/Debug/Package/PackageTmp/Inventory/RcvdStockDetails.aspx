<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="RcvdStockDetails.aspx.cs" Inherits="VOMS_ERP.Inventory.RcvdStockDetails"
     %>
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="6">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Received Stock Details"
                    ...
                    <tr>
                        <td colspan="6">
                            <table width="100%">
                                <tr>
                                    <td>
                                        <asp:GridView runat="server" ID="gvRcvdStock" Width="100%" RowStyle-CssClass="bcGridViewRowStyle"
                                            ...
                                            AlternatingRowStyle-CssClass="bcGridViewAlternatingRowStyle" OnPreRender="gvRcvdStock_PreRender"
                                            OnRowCommand="gvRcvdStock_RowCommand" OnRowDataBound="gvRcvdStock_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Quantity" DataField="DspchQty" />
                                                <asp:BoundField HeaderText="UoM" DataField="UnitNm" />
