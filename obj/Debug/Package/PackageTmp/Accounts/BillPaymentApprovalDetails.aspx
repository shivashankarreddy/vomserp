<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="BillPaymentApprovalDetails.aspx.cs" Inherits="VOMS_ERP.Accounts.BillPaymentApprovalDetails" %>
    ...
    <table class="MainTable" align="center">
        ...
        <tr>
            <td class="bcTdNewTable" align="center" colspan="3">
                <CR:CrystalReportViewer ID="CT1Details" runat="server" AutoDataBind="true"
