<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="InspectionPlanRequest.aspx.cs" Inherits="VOMS_ERP.Logistics.InspectionPlanRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="6">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Request for Inspection Plan"
    ...
    <script type="text/javascript">
        ...
        function uploadComplete() {
            var result = InspectionPlanRequest.AddItemListBox();
        ...
        $('#lnkdelete').click(function () {
            if ($('#lbItems').val() != null) {
                if (confirm("Are you sure you want to delete the item")) {
                    var result = InspectionPlanRequest.DeleteItemListBox($('#lbItems').val());
                    var getDivCEDItems = GetClientID("divListBox").attr("id");
                    $('#' + getDivCEDItems).html(result.value);
                    var listid = GetClientID("lbItems").attr("id");
                    $('#' + listid)[0].selectedIndex = '0';
