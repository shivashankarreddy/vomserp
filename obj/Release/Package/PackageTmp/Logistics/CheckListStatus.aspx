<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="CheckListStatus.aspx.cs" Inherits="VOMS_ERP.Logistics.CheckListStatus"
     %>
    ...
    <table class="MainTable" align="center">
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="Shipment Planning Status"
        ...
        <tr>
            <td>
                ...
                <asp:HiddenField ID="HFGDN" runat="server" Value="" />
                <asp:HiddenField ID="HFGRN" runat="server" Value="" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#tblCheckList').dataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "LogisticsWS.asmx/GetCheckList",
        ...
        function EditDetails(valddd, CreatedBy, IsCust) {
            try {
                var result = CheckListStatus.EditItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                var fres = result.value;
                if (fres == 'Success') {
                    window.location.replace("../Logistics/CheckList.aspx?ID=" + valddd.parentNode.parentNode.id);
                }
                else {
                    ErrorMessage(fres);
                }
        ...
        function Delet(valddd, CreatedBy, IsCust) {
            try {
                if (confirm("Are you sure you want to Delete?")) {
                    var result = CheckListStatus.DeleteItemDetails(valddd.parentNode.parentNode.id, CreatedBy, IsCust);
                    var fres = result.value;
