<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="SuplierCategoryMaster.aspx.cs" Inherits="VOMS_ERP.Masters.SuplierCategoryMaster"
     %>
                ...
                <table style="width: 98%; vertical-align: top" align="center">
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="3">
                            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Category Master" CssClass="bcTdTitleLabel"></asp:Label>
                    ...
                    <tr>
                        <td style="text-align: right;" class="bcTdnormal">
                            <font color="red" size="2"><b>*</b></font><span id="Label13" class="bcLabelright">Category
                                Name:</span>
                        </td>
                        <td>
                            &nbsp;
                        ...
                        <td class="bcTdnormal">
                            <asp:TextBox runat="server" ID="txtCtgry" class="bcAsptextbox" MaxLength="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" class="bcTdNewTable">
                            <div id="dvEnmMstr" class="DivGridSize">
                                <center>
                                    <asp:GridView runat="server" ID="gvCtgry" AutoGenerateColumns="False" RowStyle-CssClass="bcGridViewRowStyle"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Role Name" DataField="Category Name" HeaderStyle-Width="170px" />
