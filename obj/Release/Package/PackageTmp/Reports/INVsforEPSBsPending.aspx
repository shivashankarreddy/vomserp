<%@ Page  Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="INVsforEPSBsPending.aspx.cs" Inherits="VOMS_ERP.Reports.INVsforEPSBsPending" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="MainTable" align="center">
        <tr>
            <td class="bcTdNewTable">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        ...
                                        Text="LIST OF INVOICES FOR WHICH EP COPIES OF SHIPPING BILLS HAVE NOT BEEN RECEIVED"
                ...
                <table id="gvINVsforEPSBsPending" class="widthFull fontsize10 displayNone" cellpadding="0"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $("[id$=gvINVsforEPSBsPending]").dataTable({
                "oLanguage": {
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "ReportService.asmx/INVsforEPSBsPending",
                "bJQueryUI": true,
                    ...
                    $.ajax({
                        ...
                        "success":
                                function (msg) {
                                    ...
                                    fnCallback(json);
                                    $("#gvINVsforEPSBsPending").show();
                                }
                    });
                }
            });
            $("#gvINVsforEPSBsPending").dataTable().columnFilter(
                {
                    "aoColumns": [
                                    { "type": "text" },
                                    { "type": "date-range" },
            ...
            /* Init the table */
            oTable = $("#gvINVsforEPSBsPending").dataTable();
        });
    </script>
</asp:Content>
