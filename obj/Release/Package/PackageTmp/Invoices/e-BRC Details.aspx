                        ...
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList runat="server" ID="ddlShipBillNo" AutoPostBack="true" TabIndex="2"
                                            CssClass="bcAspdropdown" required="required" OnSelectedIndexChanged="ddlShipBillNo_SelectedIndexChanged">
                                ...
                                <tr>
                                    ...
                                    <td class="bcTdnormal" style="width: 185px">
                                        <asp:TextBox ID="txtRealVal" runat="server" CssClass="bcAsptextbox" onblur="extractNumber(this,2,false);"
