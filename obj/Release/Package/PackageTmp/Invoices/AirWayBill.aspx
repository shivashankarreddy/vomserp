...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                ...
                                <tr>
                                    ...
                                    <td class="bcTdnormal" style="width: 185px; height: 5px">
                                        <asp:ListBox ID="lbShippingBill" runat="server" CssClass="bcAspMultiSelectListBox"
                                ...
                                <tr>
                                    <td class="bcTdnormal" style="width: 185px">
                                        <span class="bcLabel">Dimensions in Cms<font color="red" size="2"> <b>*</b></font>:</span>
                                    </td>
                                    <td class="bcTdnormal" style="width: 185px">
                                        <asp:TextBox ID="txtDimensions" runat="server" onkeypress="return isDimension(event);"
                                            CssClass="bcAsptextbox"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal" style="width: 185px">
    ...
    <script type="text/javascript">
        function Myvalidations() {
            ...
            //                return false;
            //            }
            else if (($('[id$=txtFreight]').val()).trim() == '') {
                ErrorMessage('Freight is required.');
                $('[id$=txtFreight]').focus();
                return false;
            }
            else if (($('[id$=txtTareweight]').val()).trim() == '') {
                ErrorMessage('Tare weight is required.');
                $('[id$=txtTareweight]').focus();
                return false;
            }
            else if (($('[id$=txtGrossweight]').val()).trim() == '') {
                ErrorMessage('Gross weight is required.');
                $('[id$=txtGrossweight]').focus();
                return false;
            }
            else if (($('[id$=txtNoPkgs]').val()).trim() == '') {
