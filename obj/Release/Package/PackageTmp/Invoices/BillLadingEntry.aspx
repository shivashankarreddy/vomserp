                        ...
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:ListBox runat="server" ID="lbShpngBil" SelectionMode="Multiple" CssClass="bcAspMultiSelectListBox">
                                        </asp:ListBox>
                                    </td>
                                </tr>
                                <tr>
        ...
        function Myvalidations() {
            try {
                ...
                if ($('#ctl00_ContentPlaceHolder1_lbCustomers :selected').length == 0) {
                    ...
                    return false;
                if (($('[id$=txtIDFNo]').val()).trim() == '') {
                    ErrorMessage('IDF Number is required.');
                    $('[id$=txtIDFNo]').focus();
                    return false;
                }
                ...
                else if (($('[id$=txtGrWeight]').val()).trim() == '') {
                    ErrorMessage('Gross Weight is required.');
                    $('[id$=txtGrWeight]').focus();
                    return false;
                }
                else if (($('[id$=txtTotalPkgs]').val()).trim() == '') {
