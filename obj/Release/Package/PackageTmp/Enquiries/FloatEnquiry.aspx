<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="FloatEnquiry.aspx.cs" Inherits="VOMS_ERP.Enquiries.FloatEnquiry" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<style type="text/css">
        tr.even:hover td, #tblItems tr.even:hover .dataTable DTFC_Cloned
        {
            background-color: #CBCBCB;
        }
        tr.odd:hover td, #tblItems tr.odd:hover .dataTable DTFC_Cloned
        {
            background-color: #CBCBCB;
        }
    </style>--%>
                    ...
                    <tr class="bcTRTitleRow">
                        <td class="bcTdTitleLeft" align="left" colspan="6">
                            <table width="100%">
                                <tr>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Local Enquiry" CssClass="bcTdTitleLabel"></asp:Label><div
                        ...
                        <td>
                            <table width="100%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc">
                                ...
                                <tr>
                                    ...
                                    <td class="bcTdnormal">
                                        <span id="lblIssdt" class="bcLabel">LE Issue Date <font color="red" size="2"><b>*</b></font>
                                            :</span>
                                    </td>
                                    <td class="bcTdnormal">
                                        <asp:TextBox runat="server" ID="txtlenqdt" ValidationGroup="D" CssClass="bcAsptextbox"
                                            onchange="SetFEdate();"></asp:TextBox>
                                    </td>
                                    <td class="bcTdnormal">
                                        <span id="lblRecvDt" class="bcLabel">Response Due Date<font color="red" size="2"><b>*</b></font>:</span>
                                    </td>
                                    <td class="bcTdnormal">
                                        <asp:TextBox runat="server" ID="txtleduedt" ValidationGroup="D" CssClass="bcAsptextbox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bcTdnormal">
                                    ...
                                    <td class="bcTdnormal">
                                        <span id="lblDept" class="bcLabel">Project/Department Name<font color="red" size="2"><b>*</b></font>:</span>
                                    </td>
                                    <td class="bcTdnormal">
                                ...
                                <tr>
                                    <td class="bcTdnormal">
                                        <span id="Span2" class="bcLabel">Supplier Name(s)<font color="red" size="2"><b>*</b></font>:</span>
                                    </td>
                                    <td class="bcTdnormal">
                                        <asp:ListBox runat="server" ID="lbsuplrs" SelectionMode="Multiple" CssClass="bcAspMultiSelectListBox">
    ...
    <script type="text/javascript">
        ...
        function toolTip(id) {
            ...
            var sv = $('#' + itmid).val();
            var result = FloatEnquiry.GetHistoryItems(sv);
        ...
        function Download() {
            if ($('#lbItems').val() != "") {
                ...
                FloatEnquiry.DownloadItemListBox(list[indx].text);
            }
        }
        ...
        function doConfirm(id) {
            if (confirm("Are you sure you want to Continue?")) {
                ...
                var result = FloatEnquiry.DeleteItem(id, hfCurrentPage);
        ...
        function CheckAllBoxs() {
            ...
            var hfCurrentPage = $('[id$=hfCurrentPage]').val();
            var result = FloatEnquiry.CheckAll(CheckAll, hfCurrentPage, ddlRowsChanged);
            var getDivFEItems = GetClientID("divGridItems").attr("id");
            $('#' + getDivFEItems).html(result.value);
        ...
        function AddItemColumn(id) {
            ...
            if (sv == undefined && Qty == '') {
                ...
                if (Units == undefined)
                    Units = '';
                if ((Qty != '' && Qty != '.')) {
                    var result = FloatEnquiry.AddNewRow(id, sv, PrtNo, spec, Make, Qty, Units, Rmrks, Check, ItmADD, hfCurrentPage, ddlRowsChanged);
                    var getDivFEItems = GetClientID("divGridItems").attr("id");
                    $('#' + getDivFEItems).html(result.value);
                    ItmADD = false;
                }
        ...
        function NextPage() {
            ...
            if (ddlRowsChanged == 'NAN' || ddlRowsChanged <= 0) {
                ...
                $('div#ctl00_ContentPlaceHolder1_divGridItems').block({
                ...
                var result = FloatEnquiry.NextPage(hfCurrentPage, ddlRowsChanged);
                $('#' + getDivFEItems).html(result.value);
                Expnder();

                $('div#' + getDivFEItems).unblock();
                //                $.unblock();
            }
        };
        ...
        function PrevPage() {
            ...
            if (ddlRowsChanged == 'NAN' || ddlRowsChanged <= 0) {
                ...
                var result = FloatEnquiry.PrevPage(hfCurrentPage, ddlRowsChanged);
                var getDivFEItems = GetClientID("divGridItems").attr("id");
                $('#' + getDivFEItems).html(result.value);
                Expnder();
            }
        ...
        function RowsChanged() {
            ...
            var result = FloatEnquiry.RowsChanged(hfCurrentPage, ddlRowsChanged);
            var getDivFEItems = GetClientID("divGridItems").attr("id");
            $('#' + getDivFEItems).html(result.value);
            Expnder();
        }
        ...
        function FillItemDRP(id) {
            ...
            var ddlCat = GetClientID("ddl" + (parseInt(id))).attr("id");
            var sv = $('#' + ddlCat).val();
            var result = FloatEnquiry.FillItemDRP(id, sv, hfCurrentPage);
            var getDivFEItems = GetClientID("divGridItems").attr("id");
            $('#' + getDivFEItems).html(result.value);
            Expnder();
        }
        ...
        function FillUnitDRP(id) {
            ...
            var sv = $('#' + ddlCat).val();
            var result = FloatEnquiry.FillUnitDRP(id, sv);
            var getDivFEItems = GetClientID("divGridItems").attr("id");
            $('#' + getDivFEItems).html(result.value);
            Expnder();
        }
        ...
        function Myvalidations() {
            ...
            //                if (isChecked && ($('#ddlUnits' + '' + i).val() == '0' || $('#txtQuantity' + '' + i).val() == '0' || $('#txtQuantity' + '' + i).val() == '')) {
            ...
            if (rowCount > 0) {
                var result = FloatEnquiry.ValidateRowsBeforeSave();
            ...
            else if (($('[id$=Ddldeptnm]').val()).trim() == '00000000-0000-0000-0000-000000000000') {
                $("#<%=divMyMessage.ClientID %> span").remove();
        ...
        function FillGrid() {
            var hfCurrentPage = $('[id$=hfCurrentPage]').val();
            var result = FloatEnquiry.BindGridView($('[id$=ddlfenqy]').val(), hfCurrentPage);
        ...
        $('#lnkdelete').click(function () {
            if ($('#lbItems').val() != null) {
                ...
                if (IsDelete) {
                    var result = FloatEnquiry.DeleteItemListBox($('#lbItems').val());
