<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="NewFQuotation.aspx.cs" Inherits="VOMS_ERP.Quotations.NewFQuotation"
            ...
            <td>
                <table width="98%" style="background-color: #F5F4F4; padding: 15px; border: solid 1px #ccc"
                        ...
                        <td class="bcTdnormal" colspan="6">
                            <div style="min-height: 150px; max-height: 250px; overflow: auto;">
                                <asp:GridView runat="server" ID="gvFquoteItems" Width="100%" RowStyle-CssClass="rounded-corner"
                                    PageSize="100" GridLines="None" EmptyDataRowStyle-CssClass="rounded-corner" CssClass="rounded-corner"
                                    HeaderStyle-CssClass="rounded-corner" AlternatingRowStyle-CssClass="rounded-corner"
                                    ShowFooter="true" BorderWidth="0px" AutoGenerateColumns="false" OnRowDataBound="gvFquoteItems_RowDataBound"
                                    OnPreRender="gvFquoteItems_PreRender" AllowPaging="true">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtMargin" class="positive" onblur="extractNumber(this,2,false);"
    ...
    <script type="text/javascript">
        ...
        function getPaymentValues(RNo) {
            ...
            if (PercAmt != '0' && PercAmt != '' && Desc != '') {
                var result = NewFQuotation.PaymentAddItem(RNo, PercAmt, Desc);
                var getdivPaymentTerms = GetClientID("divPaymentTerms").attr("id");
                $('#' + getdivPaymentTerms).html(result.value);
        ...
        function fnOpen(id, rowIndex) {
            ...
            if (EditID == '00000000-0000-0000-0000-000000000000') {
                window.open("../Masters/TermsNConditions.aspx?TAr=General&LclQuteID=" + EditID + "&FQ=false", "508", "width=1000,height=500, top=" + y + ", left=" + x + ""); //../Enquiries/AddItems.aspx
            }
            else if (ED == '00000000-0000-0000-0000-000000000000') {
                window.open("../Masters/TermsNConditions.aspx?TAr=General&LclQuteID=" + EditID + "&FQ=true", "508", "width=1000,height=500,top=" + y + ", left=" + x + ""); //../Enquiries/AddItems.aspx
            }
